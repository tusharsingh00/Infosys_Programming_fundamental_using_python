...
def calculate_loan(account_number,salary,account_balance,loan_type,loan_amount_expected,customer_emi_expected):
    ...
    account_number_len = (str(account_number))
    
    if (len(account_number_len) == 4 and  account_number_len[0] == '1' ):
        if account_balance >= 100000:
            ...
            elif salary >=50000 and salary < 75000 and (loan_type == "Car" or loan_type == "House"):
...
calculate_loan(1110,75000,250000,"Car",300000,10)